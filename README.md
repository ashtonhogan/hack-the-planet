...
|             | - **Checking for Misconfigurations**: Visit HTTP/HTTPS pages for default pages or error messages. Use tools like [gobuster](https://github.com/ashtonhogan/hack-the-planet/blob/main/Tools/Usage/gobuster.md) with pre-built [payloads](https://github.com/payloadbox/directory-payload-list/tree/master/Intruder) to find hidden directories and files.                                   |
